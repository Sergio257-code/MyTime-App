                ...
                <div class="userinput">
                    <form action="" method="get" accept-charset="utf-8" class="ui form">
                        ...
                        <div class="inline field">
                           <label style="font-weight:bold; font-size:1.4em; margin-bottom:8px; display:block;">
        {{ __("Confirm time in / time out:") }}
    </label>
...
<input type="hidden" name="idno" value="{{ auth()->user()->idno }}">
    ...
    var tf = {!! json_encode(isset($tf) ? $tf : 0) !!};
    ...
    <button id="toggle-darkmode" class="ui button" style="position:fixed;top:10px;right:10px;z-index:1000;">
    🌙 Mode sombre
</button>
